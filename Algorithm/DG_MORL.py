"""DG-MORL Algorithm Adapted from GPI-PD implementation
...
class DG_MORL_discrete(MOPolicy, MOAgent):
    """DG_MORL_discrete Algorithm. Adapted from GPI-PD implementation
    ...
    def jsmorl_train_iteration(self,
        ...
        while step < total_timesteps and demo_info.horizon >= 0:
            ...
            if self.global_step % (total_timesteps) == 0:
                ...
                print(f"@{self.global_step}\tEU:{EU}\tEU_target:{EU_target}")
...
if __name__ == '__main__':
    ...
    for seed in seeds:
        ...
        # )
        #
        # # Hard-coded demo, sub-optimal. To make it worse in performance, the user can add more extra actions to it.
        ...
        #                    title="DST_seed_" + str(seed), roll_back_step=2)
        # """ -------------------DST part ends--------------------"""
        ...
        human_demos = np.load("initial_demos/Minecart/demos.npy", allow_pickle=True)

        # uncomment to do quantity sensitivity test
